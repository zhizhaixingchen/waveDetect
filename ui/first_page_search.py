...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.start_label.setText(_translate("Dialog", "开始时间："))
        self.ip.setText(_translate("Dialog", "   IP地址："))
        self.user.setText(_translate("Dialog", "   用户名："))
        self.end_label.setText(_translate("Dialog", "结束时间："))
        self.submit.setText(_translate("Dialog", "开始检索"))
        self.reset.setText(_translate("Dialog", "初始化"))
